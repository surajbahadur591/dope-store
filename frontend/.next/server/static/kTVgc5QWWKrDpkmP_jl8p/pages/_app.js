...
var locale_ = __webpack_require__(28);
...
var CartItem_CartItem = function CartItem(_ref) {
  ...
  if (!cartItem.item) return external_react_default.a.createElement(CartItemStyles, null, "This item is no longer available", external_react_default.a.createElement(components_RemoveFromCart, {
    id: cartItem.id
  }));
...
var external_react_stripe_checkout_ = __webpack_require__(22);
...
var external_nprogress_ = __webpack_require__(11);
...
var Cart_Cart = function Cart() {
  return external_react_default.a.createElement(User["b" /* default */], null, function (data) {
    ...
    return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        return external_react_default.a.createElement(styles_CartStyles, {
          ...
          onClick: toggleCart,
          title: "close"
        }, " \xD7"), external_react_default.a.createElement(styles_Supreme, null, " ", userName, "'s Bag"), external_react_default.a.createElement("p", null, " Your have ", me.cart.length, " item", me.cart.length === 1 ? '' : 's', " in your Bag")), external_react_default.a.createElement("ul", null, me.cart.map(function (cartItem) {
...
var CartCount_CartCount = function CartCount(_ref) {
  ...
  return external_react_default.a.createElement(Dot, null, count);
};
...
var SEARCH_ITEM_QUERY = external_graphql_tag_default()(Search_templateObject());
...
var Header_Header = function Header() {
  return external_react_default.a.createElement(StyledHeader, null, external_react_default.a.createElement("div", {
    ...
    href: "/"
  }, external_react_default.a.createElement("a", null, "Dope Store"))), external_react_default.a.createElement(components_Nav, null)), external_react_default.a.createElement("div", {
    className: "sub-bar"
  }, " ", external_react_default.a.createElement(Search, null, "Search")), external_react_default.a.createElement(components_Cart, null));
};
...
var Meta_Meta = function Meta() {
  ...
  }), external_react_default.a.createElement("title", null, "Dope Store")));
};
...
})(["background:white;color:", ";"], Page_theme.black);
var Inner = external_styled_components_default.a.div.withConfig({
  displayName: "Page__Inner",
  componentId: "sc-4u7a64-1"
})(["max-width:", ";margin:0 auto;padding:2rem;background-color:", ";"], Page_theme.maxWidth, Page_theme.lightgrey);
Object(external_styled_components_["injectGlobal"])(Page_templateObject(), Page_theme.black);
...
var external_next_with_apollo_ = __webpack_require__(25);
var external_next_with_apollo_default = /*#__PURE__*/__webpack_require__.n(external_next_with_apollo_);

// EXTERNAL MODULE: external "apollo-boost"
var external_apollo_boost_ = __webpack_require__(26);
...
function (_App) {
  ...
  _app_createClass(MyApp, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(app_["Container"], null, external_react_default.a.createElement(external_react_apollo_["ApolloProvider"], {
        client: apollo
