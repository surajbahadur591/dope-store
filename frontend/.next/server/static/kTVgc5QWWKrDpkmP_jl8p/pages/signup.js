    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_styles_Form__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
          ...
          disabled: loading,
          "aria-busy": loading
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h2", null, " Sign In"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_ErrorMessage__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
          error: error
...
function RequestReset_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { RequestReset_typeof = function _typeof(obj) { return typeof obj; }; } else { RequestReset_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return RequestReset_typeof(obj); }
...
function RequestReset_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function RequestReset_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function RequestReset_createClass(Constructor, protoProps, staticProps) { if (protoProps) RequestReset_defineProperties(Constructor.prototype, protoProps); if (staticProps) RequestReset_defineProperties(Constructor, staticProps); return Constructor; }

function RequestReset_possibleConstructorReturn(self, call) { if (call && (RequestReset_typeof(call) === "object" || typeof call === "function")) { return call; } return RequestReset_assertThisInitialized(self); }

function RequestReset_getPrototypeOf(o) { RequestReset_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return RequestReset_getPrototypeOf(o); }

function RequestReset_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) RequestReset_setPrototypeOf(subClass, superClass); }

function RequestReset_setPrototypeOf(o, p) { RequestReset_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return RequestReset_setPrototypeOf(o, p); }

function RequestReset_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var RequestReset_RequestReset =
/*#__PURE__*/
function (_Component) {
  RequestReset_inherits(RequestReset, _Component);
  ...
  function RequestReset() {
    ...
    RequestReset_classCallCheck(this, RequestReset);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = RequestReset_possibleConstructorReturn(this, (_getPrototypeOf2 = RequestReset_getPrototypeOf(RequestReset)).call.apply(_getPrototypeOf2, [this].concat(args)));

    RequestReset_defineProperty(RequestReset_assertThisInitialized(RequestReset_assertThisInitialized(_this)), "state", {
      email: ''
    });

    RequestReset_defineProperty(RequestReset_assertThisInitialized(RequestReset_assertThisInitialized(_this)), "saveToState", function (e) {
      _this.setState(RequestReset_defineProperty({}, e.target.name, e.target.value));
    });

    return _this;
  }

  RequestReset_createClass(RequestReset, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        return external_react_default.a.createElement(Form["a" /* default */], {
          ...
          disabled: loading,
          "aria-busy": loading
        }, external_react_default.a.createElement("h2", null, "Password Reset"), external_react_default.a.createElement(ErrorMessage["a" /* default */], {
          error: error
        }), !error && !loading && called && external_react_default.a.createElement("p", null, " Check your EMAIL for a reset LINK"), external_react_default.a.createElement("label", {
          htmlFor: "email"
        }, "EMAIL", external_react_default.a.createElement("input", {
          type: "email",
          name: "email",
...
var signup_SignupPage = function SignupPage(props) {
  return external_react_default.a.createElement(Column, null, external_react_default.a.createElement(components_Signup, null), external_react_default.a.createElement(Signin["a" /* default */], null), external_react_default.a.createElement(components_RequestReset, null));
};
